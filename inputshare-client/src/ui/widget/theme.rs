...
pub const NORD4: Color = Color::from_rgba32_u32(0xd8dee9ff);
pub const NORD5: Color = Color::from_rgba32_u32(0xe5e9f0ff);
pub const NORD6: Color = Color::from_rgba32_u32(0xeceff4ff);

pub struct LightTheme;
impl Theme for LightTheme {
    fn apply(env: &mut Env) {
        env.set(theme::BUTTON_DARK, NORD6);
        env.set(theme::BUTTON_LIGHT, NORD6);
        env.set(theme::DISABLED_BUTTON_DARK, NORD5);
        env.set(theme::DISABLED_BUTTON_LIGHT, NORD5);
        env.set(theme::TEXT_COLOR, Color::BLACK);
        env.set(theme::WINDOW_BACKGROUND_COLOR, NORD4);
        env.set(theme::BACKGROUND_LIGHT, NORD4);
